...
import 'complete_profile_profe_copy_model.dart';
export 'complete_profile_profe_copy_model.dart';

class CompleteProfileProfeCopyWidget extends StatefulWidget {
  const CompleteProfileProfeCopyWidget({Key? key}) : super(key: key);

  @override
  _CompleteProfileProfeCopyWidgetState createState() =>
      _CompleteProfileProfeCopyWidgetState();
}

class _CompleteProfileProfeCopyWidgetState
    extends State<CompleteProfileProfeCopyWidget>
    with TickerProviderStateMixin {
  late CompleteProfileProfeCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompleteProfileProfeCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CarrerasRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CarrerasRecord> completeProfileProfeCopyCarrerasRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final completeProfileProfeCopyCarrerasRecord =
            completeProfileProfeCopyCarrerasRecordList.isNotEmpty
                ? completeProfileProfeCopyCarrerasRecordList.first
                : null;
                        ...
                        child: Column(
                          ...
                          children: [
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            20.0, 20.0, 20.0, 0.0),
                                        child:
                                            StreamBuilder<List<CarrerasRecord>>(
                                          stream: queryCarrerasRecord(),
                                          builder: (context, snapshot) {
                                            // Customize what your widget looks like when it's loading.
                                            if (!snapshot.hasData) {
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 24.0, 0.0, 0.0),
                              child: StreamBuilder<List<CarrerasRecord>>(
                                stream: queryCarrerasRecord(
                                  queryBuilder: (carrerasRecord) =>
                                      carrerasRecord.where(
                                    'nombre_carrera',
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<CarrerasRecord>
                                      buttonLoginCarrerasRecordList =
                                      snapshot.data!;
                                  // Return an empty Container when the item does not exist.
                                  if (snapshot.data!.isEmpty) {
                                    return Container();
                                  }
                                  final buttonLoginCarrerasRecord =
                                      buttonLoginCarrerasRecordList.isNotEmpty
                                          ? buttonLoginCarrerasRecordList.first
                                          : null;
                                    ...
                                    onPressed: () async {
                                      await currentUserReference!.update({
                                        ...createUsersRecordData(
                                          ...
                                          phoneNumber:
                                              _model.nrocelularController.text,
                                          userName:
                                              _model.nombreController.text,
                                      ...
                                      await AlumnoRecord.collection
                                          ...
                                          .set(createAlumnoRecordData(
                                            ...
                                            carrera: buttonLoginCarrerasRecord
                                                ?.reference,
                                            carreraId: buttonLoginCarrerasRecord
                                                ?.nombreCarrera,
                                          ));
