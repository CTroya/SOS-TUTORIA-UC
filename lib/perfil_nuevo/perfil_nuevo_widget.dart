...
import 'perfil_nuevo_model.dart';
export 'perfil_nuevo_model.dart';

class PerfilNuevoWidget extends StatefulWidget {
  const PerfilNuevoWidget({Key? key}) : super(key: key);

  @override
  _PerfilNuevoWidgetState createState() => _PerfilNuevoWidgetState();
}

class _PerfilNuevoWidgetState extends State<PerfilNuevoWidget>
    with TickerProviderStateMixin {
  late PerfilNuevoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PerfilNuevoModel());
                        ...
                        child: Padding(
                          ...
                          child: StreamBuilder<List<AlumnoRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<AlumnoRecord> containerAlumnoRecordList =
                                  snapshot.data!;
                              final containerAlumnoRecord =
                                  containerAlumnoRecordList.isNotEmpty
                                      ? containerAlumnoRecordList.first
                                      : null;
                              return Container(
                                width: double.infinity,
                                height: 800.0,
