...
import 'solicitar_ser_tutor_model.dart';
export 'solicitar_ser_tutor_model.dart';

class SolicitarSerTutorWidget extends StatefulWidget {
  const SolicitarSerTutorWidget({Key? key}) : super(key: key);

  @override
  _SolicitarSerTutorWidgetState createState() =>
      _SolicitarSerTutorWidgetState();
}

class _SolicitarSerTutorWidgetState extends State<SolicitarSerTutorWidget> {
  late SolicitarSerTutorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SolicitarSerTutorModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<MateriasRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MateriasRecord> solicitarSerTutorMateriasRecordList =
            snapshot.data!;
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      controller:
                                          _model.materiaValueController ??=
                                              FormFieldController<String>(null),
                                      options: List<String>.from(
                                          solicitarSerTutorMateriasRecordList
                                              .map((e) => e.nombreMateria)
                                              .toList()),
                                      optionLabels:
                                          solicitarSerTutorMateriasRecordList
                                              .map((e) => e.nombreMateria)
