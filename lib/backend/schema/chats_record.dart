...
class ChatsRecord extends FirestoreRecord {
  ...
  // "tutoriaDetalle" field.
  DocumentReference? _tutoriaDetalle;
  DocumentReference? get tutoriaDetalle => _tutoriaDetalle;
  bool hasTutoriaDetalle() => _tutoriaDetalle != null;
  ...
  void _initializeFields() {
    ...
    _tutoriaDetalle = snapshotData['tutoriaDetalle'] as DocumentReference?;
...
Map<String, dynamic> createChatsRecordData({
  ...
  DocumentReference? tutoriaDetalle,
  String? estado,
}) {
...
class ChatsRecordDocumentEquality implements Equality<ChatsRecord> {
  ...
  bool equals(ChatsRecord? e1, ChatsRecord? e2) {
    ...
    return listEquality.equals(e1?.users, e2?.users) &&
        ...
        e1?.tutoriaDetalle == e2?.tutoriaDetalle &&
        e1?.estado == e2?.estado;
  }
