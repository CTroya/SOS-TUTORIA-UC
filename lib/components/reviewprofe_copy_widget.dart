...
import 'reviewprofe_copy_model.dart';
export 'reviewprofe_copy_model.dart';

class ReviewprofeCopyWidget extends StatefulWidget {
  const ReviewprofeCopyWidget({
    Key? key,
  ...
  @override
  _ReviewprofeCopyWidgetState createState() => _ReviewprofeCopyWidgetState();
}

class _ReviewprofeCopyWidgetState extends State<ReviewprofeCopyWidget> {
  late ReviewprofeCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReviewprofeCopyModel());
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: FlutterFlowCheckboxGroup(
                              options: [
                                'Cumplio con el Horario',
                                'Presta Atencion a la tutoria',
                                'Se dio la tutoria'
                              ],
                              ...
                              builder: (context, snapshot) {
                                ...
                                return FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    _model.tutoria = await TutoriasDetalleRecord
                                        .getDocumentOnce(
                                            widget.tutoriareference!);
                                    ...
                                    await reviewRecordReference.set({
                                      ...createReviewRecordData(
                                        ...
                                        reviewed: _model.tutoriaP?.idUser,
                                      ),
                                      ...mapToFirestore(
                                        {
                                          'comentario_list':
